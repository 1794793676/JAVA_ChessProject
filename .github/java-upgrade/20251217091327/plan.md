...
- **Working branch**: appmod/java-upgrade-20251217091327
...
- **Target JDK path (Java 21)**: C:\Program Files\Eclipse Adoptium\jdk-21.0.9.10-hotspot\bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251217091327`.
